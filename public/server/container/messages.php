...
class Container_messages {
  static public function postMsgToUserChannels($uid, $body, $type = 'msg') {
    foreach (Container_users::getUserChannels($uid) as $cid) {
        self::postMsgToChannel($cid,$uid,$body,$type);
    }
  }
  /**
   * cid : recipient
